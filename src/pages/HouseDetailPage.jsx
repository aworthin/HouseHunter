...
export default function HouseDetailPage() {
  ...
  return (
    <div className="min-h-dvh bg-stone-950">
      ...
      <div className="px-4 py-5 space-y-6 pb-52 md:pb-2">
        {/* Images */}
      ...
      <div className="fixed md:static bottom-0 left-0 right-0 bg-stone-950/95 md:bg-transparent backdrop-blur-md md:backdrop-blur-none border-t border-stone-800 md:border-t-0 px-4 pt-3 md:pb-6 md:mt-4" style={{ bottom: "2.25rem", paddingBottom: "calc(env(safe-area-inset-bottom) + 0.5rem)" }}>
