...
export default function HouseDetailPage() {
  ...
  return (
    <div className="min-h-dvh bg-stone-950">
      ...
      {/* Bottom action bar */}
      <div className="fixed left-0 right-0 bg-stone-950/95 backdrop-blur-md border-t border-stone-800 px-4 pt-3 pb-3" style={{ bottom: "calc(env(safe-area-inset-bottom) + 2.5rem)" }}>
